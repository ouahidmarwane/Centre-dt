...
export default async function MfaChallengePage() {
  ...
  return <MfaFrame title="Confirmez votre identité" description="Entrez le code actuel de votre application d’authentification pour ouvrir l’espace médecin."><ChallengeForm /></MfaFrame>;
}
